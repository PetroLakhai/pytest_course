...
class BasicCompanyIPiTestCase(TestCase):
    def setUp(self) -> None:
        self.client = Client()
...
class TestGetCompanies(BasicCompanyIPiTestCase):
...
class TestPostCompanies(BasicCompanyIPiTestCase):
    def test_create_company_without_arguments_should_fall(self) -> None:
    ...
    def test_create_company_with_wrong_status_should_fall(self) -> None:
        response = self.client.post(
            path=self.companies_url,
