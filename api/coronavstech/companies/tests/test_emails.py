...
def test_send_email_should_succeed(mailoutbox, settings) -> None:
    ...
    mail.send_mail(
        ...
        message="Test Here is a message.",
        from_email="testemail@gmail.com",
        recipient_list=["testemail@gmail.com"],
        fail_silently=False,
    )
...
#     with patch(
#         "api.coronavstech.companies.views.send_email"
...
#             subject=None,
#             message=None,
#             from_email="markobarellaturin@gmail.com",
#             recipient_list=["markobarellaturin@gmail.com"],
#         )


def test_send_email_with_get_verb_should_fall(client) -> None:
